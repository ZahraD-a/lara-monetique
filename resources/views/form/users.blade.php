                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="d-flex align-items-center mb-8">
                                                                        ...
                                                                        <div class="symbol mr-5 pt-1">
                                                                            <div class="symbol-label min-w-65px min-h-100px" style="background-image: url('/metronic/theme/html/demo1/dist/assets/media/books/4.png')"></div>
                                                                        </div>
                                                                        <!--end::Symbol-->
                                                                        <!--begin::Info-->
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr class="font-weight-boldest border-bottom-0">
                                                                                        ...
                                                                                        <!--begin::Symbol-->
                                                                                        <div class="symbol symbol-40 flex-shrink-0 mr-4 bg-light">
                                                                                            <div class="symbol-label" style="background-image: url('/metronic/theme/html/demo1/dist/assets/media/products/2.png')"></div>
                                                                                        </div>
                                                                                        <!--end::Symbol-->
                                                                                        Headphones</td>
                                                                                    ...
                                                                                    <tr class="font-weight-boldest border-bottom-0">
                                                                                        ...
                                                                                        <!--begin::Symbol-->
                                                                                        <div class="symbol symbol-40 flex-shrink-0 mr-4 bg-light">
                                                                                            <div class="symbol-label" style="background-image: url('/metronic/theme/html/demo1/dist/assets/media/products/1.png')"></div>
                                                                                        </div>
                                                                                        <!--end::Symbol-->
                                                                                        Smartwatch</td>
                                                                                        <td class="border-top-0 text-right py-4 align-middle">1</td>
                                                ...
                                                <table class="table table-head-custom table-vertical-center"
                                                    ...
                                                    <thead>
                                                        <tr class="text-left">
                                                            ...
                                                            <th class="pl-0" style="min-width: 120px">Order id
                                                            </th>
