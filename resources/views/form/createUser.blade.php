        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
            <div class="kt-portlet kt-portlet--tabs">
                ...
                <div class="kt-portlet__body">
                    <form action="{{ url('form/user/store') }}" method="post">
                        @csrf
                                            ...
                                            <div class="kt-section__body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-9 col-xl-6">
                                                        <h3 class="kt-section__title kt-section__title-sm">User
                                                            Information:</h3>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <input href="{{ url('form/users') }}" type="submit" class="btn btn-sm btn-info"
                                                        value="Save">
                                                    <input type="submit" href="{{ url('form/users') }}" class="btn btn-sm btn-warning" value="Reset">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
