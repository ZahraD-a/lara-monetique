                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="kt-portlet">
                            ...
                            <form action="{{  route('products.update',$produit->id) }}" method="post" id="myForm"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6 :">
                                            ...
                                            <select id="category " name="category" class="form-control"
                                                value="{{ $produit->category }}" required>
                                                <option value="Food" name="sexe">Food</option>
                                                <option value="Poisson" name="sexe">Poissons</option>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group text-center mb-3 " style="width: 110px">
                                            ...
                                            <input type="text" name="quantite" class="form-control qty-input text-center"
                                                value="{{ $produit->quantite }}" value="1" />
