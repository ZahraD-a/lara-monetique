                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="label label-lg label-light-warning label-inline">Employer</span>
                                                </td>
                                                <td class="pr-0 text-right">

                                                    <a href="{{"form/edit/" .$user->id }}"
                                                    ...
                                                    <a href="{{ url('form/destroy/' . $user->id) }}" class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                                        <span class="svg-icon svg-icon-md svg-icon-primary">
