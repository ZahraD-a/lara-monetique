                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="admin/boutique"
                                        class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">Boutiques</a>
                                    <div class="text-dark-75">List of restaurant </div>
                                </div>
                                <!--end::Content-->
                            </div>
                        </div>
                    ...
                    <div class="card card-custom wave wave-animate-slow wave-danger mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <!--begin::Content-->
                                <div class="d-flex flex-column">
                                    <a href="boutique/factures"
                                        class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">Factures</a>
                                    <div class="text-dark-75">validéee &amp; N-validée</div>
                                </div>
                                <!--end::Content-->
                            </div>
                        </div>
                    ...
                    <div class="card card-custom wave wave-animate-slow wave-success mb-8 mb-lg-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center p-5">
                                ...
                                <!--begin::Content-->
                                <div class="d-flex flex-column">
                                    <a href="etudiant/list"
                                        class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">Etudiants
                                        Uiv</a>
                                    <div class="text-dark-75">Complete list</div>
                                </div>
                                <!--end::Content-->
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-primary font-weight-bolder d-block font-size-lg">
                                                <img src="{{ Storage::url($student->image) }}" width="60" height="60"
                                                    alt="image" />
                                            </span>
                                        ...
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $student->nom }}
                                                {{ $student->prenom }}</span>
                                            <span class="text-muted font-weight-bold"></span>
                                        </td>
                                        ...
                                        <td>
                                            <span
                                                class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $student->solde }}
                                                Dh</span>
                                            <span class="text-muted font-weight-bold"> </span>
                                        </td>
